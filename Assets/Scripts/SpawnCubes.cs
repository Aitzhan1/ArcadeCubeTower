...
public class SpawnCubes : MonoBehaviour
{
    ...
    private float camToYPosition, camMoveSpeed=2f;
    ...
    private void Start()
    {
        ...
        camToYPosition = 5.9f + nowCube.y - 1f;
    ...
    private void Update()
    {
        ...
        mainCam.localPosition = Vector3.MoveTowards(mainCam.localPosition,
            new Vector3(mainCam.localPosition.x, camToYPosition, mainCam.localPosition.z), camMoveSpeed * Time.deltaTime);
